...
| FR-09 | 패널 닫기 버튼 + 가로 리사이즈 핸들 | Medium | Pending |
...
1. [ ] `/pdca design page-citation-viewer` — 3 architecture options 생성 + 선택
2. [ ] Design 문서에 구체적 인터페이스/API 정의
3. [ ] `/pdca do page-citation-viewer` — 구현 (3 phase 모듈 분할 권장)
4. [ ] `/pdca analyze page-citation-viewer` — gap detection
5. [ ] Smoke test 및 회귀 검증
