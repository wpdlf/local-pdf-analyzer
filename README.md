...
**Quality assurance**
- 2395 unit tests + Playwright E2E + CI quality gates, plus a 4-agent parallel QA round on every release
...
| Testing | Vitest, 2395 unit tests / 116 files (renderer·shared 1511 + main 884) + Playwright E2E (10 CI-deterministic tests) + `tsc --noEmit` type check + CI coverage gates (81/74/81/84) |
...
└── renderer/             # React UI
    ...
    │   └── __tests__/         # Unit tests (2395, 116 files)
    └── types/
