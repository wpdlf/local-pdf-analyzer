...
**Quality assurance**
- 2456 unit tests + Playwright E2E + CI quality gates, plus a 4-agent parallel QA round on every release
...
| Testing | Vitest, 2456 unit tests / 117 files (renderer·shared 1565 + main 891) + Playwright E2E (10 CI-deterministic tests) + `tsc --noEmit` type check + CI coverage gates (81/74/81/85) |
...
└── renderer/             # React UI
    ...
    │   └── __tests__/         # Unit tests (2456, 117 files)
    └── types/
