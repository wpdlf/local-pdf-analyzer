...
**Quality assurance**
- 1395 unit tests + Playwright E2E + CI quality gates, plus a 4-agent parallel QA round on every release
...
| Testing | Vitest, 1395 unit tests / 82 files (renderer·shared 927 + main 468) + Playwright E2E (9 CI-deterministic tests) + `tsc --noEmit` type check + CI coverage gates (80/72/80/83) |
...
└── renderer/             # React UI
    ...
    │   └── __tests__/         # Unit tests (1395, 82 files)
    └── types/
