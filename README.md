...
**Quality assurance**
- 2356 unit tests + Playwright E2E + CI quality gates, plus a 4-agent parallel QA round on every release
...
| Testing | Vitest, 2356 unit tests / 115 files (renderer·shared 1481 + main 875) + Playwright E2E (10 CI-deterministic tests) + `tsc --noEmit` type check + CI coverage gates (81/74/81/84) |
...
└── renderer/             # React UI
    ...
    │   └── __tests__/         # Unit tests (2356, 115 files)
    └── types/
