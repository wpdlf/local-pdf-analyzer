...
**Quality assurance**
- 2376 unit tests + Playwright E2E + CI quality gates, plus a 4-agent parallel QA round on every release
...
| Testing | Vitest, 2376 unit tests / 115 files (renderer·shared 1492 + main 884) + Playwright E2E (10 CI-deterministic tests) + `tsc --noEmit` type check + CI coverage gates (81/74/81/84) |
...
└── renderer/             # React UI
    ...
    │   └── __tests__/         # Unit tests (2376, 115 files)
    └── types/
