...
**Quality assurance**
- 1961 unit tests + Playwright E2E + CI quality gates, plus a 4-agent parallel QA round on every release
...
| Testing | Vitest, 1961 unit tests / 106 files (renderer·shared 1251 + main 710) + Playwright E2E (10 CI-deterministic tests) + `tsc --noEmit` type check + CI coverage gates (79/71/78/82) |
...
└── renderer/             # React UI
    ...
    │   └── __tests__/         # Unit tests (1961, 106 files)
    └── types/
