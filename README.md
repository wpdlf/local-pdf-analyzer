...
**Quality assurance**
- 2099 unit tests + Playwright E2E + CI quality gates, plus a 4-agent parallel QA round on every release
...
| Testing | Vitest, 2099 unit tests / 108 files (renderer·shared 1362 + main 737) + Playwright E2E (10 CI-deterministic tests) + `tsc --noEmit` type check + CI coverage gates (80/72/80/83) |
...
└── renderer/             # React UI
    ...
    │   └── __tests__/         # Unit tests (2099, 108 files)
    └── types/
