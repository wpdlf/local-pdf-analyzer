...
// v0.18.20 R32 P2: sanitizeErrorPath 는 error-sanitize.ts 로 추출. store.ts 의 setError 가
// React 트리를 import 하지 않고 sanitize 만 재사용할 수 있도록 분리. 기존 호출자(이 파일,
// 테스트, 외부) 를 깨지 않기 위해 같은 이름으로 re-export.
export { sanitizeErrorPath };
